...
module.exports = class SVGSpritemapPlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.make.tap(plugin, (compilation) => {
            ...
            // Generate styles
            // todo RSPACK - hooks.afterHash doesn't exist
            ...
            // todo RSPACK - hooks.beforeChunks doesn't exist
    ...
    generateSpritemap(compiler, callback) {
        ...
        if (typeof compiler.modifiedFiles !== 'undefined' && !intersection([...this.files, ...this.directories], Array.from(compiler.modifiedFiles)).length) {
            callback();
            return;
        }
    ...
    updateFilename(identifier, compilation) {
        ...
        // todo RSPACK - updateAsset does exist, but this currently throws TypeError: source.source is not a function
