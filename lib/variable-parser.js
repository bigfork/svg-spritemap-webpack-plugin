...
const rewriter = (svg, fn) => {
    // todo RSPACK - svg is a RawSource instance... not sure if it is in webpack, but we have to call .source() to get a string in RSPACK
    return svg.source().replace(VAR_REGEX, (match, name, attribute, value) => {
